...
A Associação 641, incubadora de projetos musicais emergentes sediada em Oeiras, abre o presente concurso (Open Call) destinado à seleção de Bandas Residentes para utilização das salas de ensaio e Laboratório de Inovação Musical. Este regulamento define as condições de candidatura, seleção e modelo cooperativo aplicável aos vencedores.  
A leitura deste documento não dispensa a consulta e aceitação do **Regulamento Interno da Associação 641**, cujas regras de conservação, segurança e funcionamento do espaço se aplicam integralmente a todas as bandas selecionadas (disponível para consulta [aqui](https://drive.google.com/drive/folders/10yfI08c7mFxI_TyOwl-N3wMLpevA6XnH?usp=sharing)).

## **Capítulo I — Objeto e Destinatários**

### **Artigo 1.º — Objeto**

O presente regulamento estabelece as normas do concurso (Open Call) destinado à seleção de **Bandas Residentes** para integração na Associação 641, garantindo-lhes um local de ensaio regular, apoio à produção e integração num ecossistema cultural e associativo. A residência artística tem a **duração de um ano**, não renovável.
...
- Pelo menos **50% da constituição do projeto musical deve ter ligação comprovada ao concelho de Oeiras** (residência, trabalho ou estudo). No caso de bandas com um número ímpar de elementos, o valor é arredondado para o número inteiro imediatamente superior (ex: numa banda de 3 pessoas, 2 necessitam de cumprir este critério).
...
As candidaturas serão avaliadas de 0 a 10 valores, de acordo com a seguinte matriz baseada na missão da Associação 641:

| Critério | Descrição | Peso (%) |
| :---- | :---- | :---- |
| **A. Necessidade de Espaço** | Demonstração clara da falta de condições atuais para ensaio e eventual contexto de dificuldade económica ou de acesso a infraestruturas culturais adequadas. | 35% |
| **B. Espírito Cooperativo e Impacto** | Motivação para integrar a associação, vontade de contribuir ativamente para o espaço coletivo e qualidade/solidez da proposta de contrapartida apresentada. | 30% |
| **C. Viabilidade e Compromisso** | Comprovação clara e expressa da disponibilidade da banda para usufruir do espaço. Os candidatos devem demonstrar como garantirão uma utilização regular, pontual e consistente da sala, bem como o compromisso com o modelo cooperativo. | 20% |
| **D. Qualidade, Potencial e Originalidade** | Avaliação da capacidade técnica, criativa, originalidade da proposta artística e do potencial de crescimento do projeto na incubadora. | 10% |
| **E. Diversidade e Inclusão** | Alinhamento com a missão da 641 na promoção da igualdade de oportunidades (ex: valorização da presença feminina e diversidade de perfis). | 5% |
...
### **Artigo 8.º — Vantagens e Contrapartidas Oferecidas**
...
### **Artigo 11.º — Remissão Externa**

Todas as regras relativas a limpezas, arrumação, consumos, horários, responsabilização por avarias e regime disciplinar encontram-se descritas no [Regulamento Interno da Associação 641](https://drive.google.com/drive/folders/10yfI08c7mFxI_TyOwl-N3wMLpevA6XnH?usp=sharing). A submissão da candidatura implica o conhecimento e aceitação tácita de todas as alíneas do referido documento.

### **Artigo 12.º — Incumprimento e Perda de Vaga**

O incumprimento sistemático das regras de utilização do espaço, a falta de zelo pelo equipamento partilhado, a não comparência não justificada aos ensaios calendarizados, a prestação de falsas declarações na candidatura, o abandono voluntário da residência, a recusa reiterada do modelo cooperativo ou a falha na contribuição de sustentabilidade constituem motivo para a suspensão imediata da residência artística e consequente perda da vaga a favor de uma banda suplente do Open Call.
